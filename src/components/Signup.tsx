...
function Signup1() {
  ...
  return (
    <div className='backdrop-blur-sm z-50  flex fixed inset-0 justify-center items-center w-auto h-screen '>
      <div className=' rounded-2xl w-[310px] shadow-xl shadow-white bg-indigo-50 h-[400px] text-center mt-16 '>
        <div className='flex'>
            ...
            <h4 className='text-neutral-600 '>Welcome ! Please Sign up continue</h4>
            <div className='flex flex-col gap-5 m-6 '>
                ...
                <button className='p-3.5 rounded-2xl shadow-2xl text-white cursor-pointer text-center bg-gradient-to-b from-[#1e1b4b]  via-[#312e81] to-[#ddd6fe] '>Sign up</button>
