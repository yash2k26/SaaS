...
function Pricing() {
    ...
    return (
      <div onClick={()=>setform(null)} className='backdrop-blur-sm z-50 gap-5 flex fixed inset-0 justify-center p-10 items-center w-auto h-screen '>
        <div onClick={(e)=>e.stopPropagation()} className='rounded-2xl flex flex-col  shadow-2xl h-[400px] w-[250px] bg-white/15 p-5 '>
        ...
        <div onClick={(e)=>e.stopPropagation()} className='rounded-2xl shadow-2xl font-serif text-center h-[450px] w-[350px] bg-white/15 p-5'>
        ...
        <div onClick={(e)=>e.stopPropagation()} className='rounded-2xl shadow-2xl  text-center  h-[400px] w-[250px] bg-white/15 p-5 '>
            <h1 className='text-xl text-wrap font-extrabold font-serif'>Buisness Plan</h1>
            <h3 className=''>Best for enterprise use. </h3>
            <div className='flex flex-col gap-60'>
                <h1 className='text-lg'>$100/500 credits</h1>
